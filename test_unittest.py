...
class Test_Testextraction(unittest.TestCase):
    ...
    def test_result_to_json(self):
        ...
        dict_json_resultat = {
            ...
            'intents': {
                'Booking':
                '<botbuilder.core.intent_score.IntentScore object at 0x000001A5577C08E0>'
            },
            'entities': {
                'FlyOrder': [{
                    'Fly': [{
                ...
                'datetime': [{
                    'timex': ['(XXXX-08-27,XXXX-09-04,P8D)'],
                    'type': 'daterange'
                }],
                'money': [{
                    'number': 3500,
        ...
        self.assertEqual(extraction.result_to_json(dict_json),
                         dict_json_resultat)
    ...
    def test_parse_date(self):
        dict_test = {
            "AUG 27": datetime.datetime(2022, 8, 27, 0, 0),
    ...
    def test_message_si_manque_info(self):
        ...
        dict_extract_2 = {
            'text':
            'I would like to go from Dijon to Taiwan, but I only have 2000 dollars. My trip is from June the 9 to august the 10',
            'or_city': 'None',
            'dst_city': 'Taiwan',
            'str_date': datetime.date(2022, 6, 9),
        ...
        self.assertEqual(extraction.message_si_manque_info(dict_extract_1),
                         message_1)
        self.assertEqual(extraction.message_si_manque_info(dict_extract_2),
                         message_2)
        self.assertEqual(extraction.message_si_manque_info(dict_extract_3),
                         message_3)
